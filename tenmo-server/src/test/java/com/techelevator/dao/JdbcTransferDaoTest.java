...
INSERT INTO transfer (transfer_type_id,transfer_status_id,account_from,account_to,amount)
    ...
    private static final Account ACCOUNT_2002 = new Account(BigDecimal.valueOf(1000.00));
    private static final Account ACCOUNT_2003 = new Account(BigDecimal.valueOf(1000.00));
